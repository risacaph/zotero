...

{
	class ItemMessagePane extends XULElementBase {
		content = MozXULElement.parseXULToFragment(`
			...
			<groupbox id="trellis-item-pane-groupbox" pack="center" align="center">
				<vbox id="trellis-item-pane-message-box"/>
			</groupbox>
		`);

		init() {
			this._messageBox = this.querySelector('#trellis-item-pane-message-box');
		}
