...
import-source-file =
    .label = 파일 (BiBTeX, RIS, Trellis RDF 등)
...
publications-intro = 내 출판물에 추가한 항목은 trellis.org 사이트에서 당신의 프로필 페이지에 게시됩니다. 첨부 파일을 포함하기로 결정했다면, 첨부 파일이 지정한 라이선스를 따라 공개 게시됩니다. 스스로 만든 저작물만 추가하시고, 공공 배포 권한이 있으며 그렇게 하기를 희망하는 파일만 포함해주세요.
...
publications-sharing-text = 저작물에 대한 모든 권리를 보유하거나, Creative Commons 라이선스를 적용하거나, 퍼블릭 도메인으로 기증할 수 있습니다. 라이선스 선택 여부와 무관하게, 저작물은 trellis.org에서 공공 열람할 수 있게 됩니다.
publications-sharing-prompt = 당신의 저작물을 다른 사람들과 공유할 수 있도록 허락하시겠습니까?
publications-sharing-reserved =
    .label = 아니오, 내 저작물을 trellis.org 사이트에 게시하기만 하겠습니다.
