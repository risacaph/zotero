...
import-source-file =
    .label = En fil (BibTeX, RIS, Trellis RDF osv.)
...
publications-intro = Elementer, som tilføjes til Mine publikationer, vil vises på din profilside på trellis.org. Vælger du at inkludere vedhæftede filer, vil de være offentligt tilgængelige under den licens, du angiver. Tilføj kun værker, du selv har lavet, og inkludér kun filer, hvis du har rettighederne til at distribuere dem og ønsker at gøre det.
...
publications-sharing-text = Du kan beholde alle rettigheder til dit værk, licensere det under en Creative Commons-licens eller gøre det frit tilgængeligt. Under alle omstændigheder vil værket være offentligt tilgængeligt på trellis.org.
publications-sharing-prompt = Må værket deles af andre?
publications-sharing-reserved =
    .label = Nej, udgiv kun værket på trellis.org
