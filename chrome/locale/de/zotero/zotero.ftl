...
import-source-file =
    .label = Einer Datei (BibTeX, RIS, Trellis RDF, etc.)
...
import-mendeley-encrypted = Die ausgewählte Mendeley-Datenbank kann nicht gelesen werden, wahrscheinlich weil sie verschlüsselt ist. Lesen Sie <a data-l10n-name="mendeley-import-kb">How do I import a Mendeley library into Trellis? (Englisch)</a> für mehr Informationen.
...
publications-sharing-text = Sie können sich alle Rechte auf Ihr Werk vorbehalten, es unter einer Creative-Commons-Lizenz stellen oder das Werk gemeinfrei machen. Unter jeder dieser Optionen wird das Werk auf trellis.org öffentlich zugänglich gemacht.
publications-sharing-prompt = Wollen Sie anderen erlauben, Ihr Werk zu teilen?
publications-sharing-reserved =
    .label = Nein, ich möchte mein Werk nur auf trellis.org verfügbar machen
...
account-not-logged-in-text = Mit einem Trellis-Account anmelden, um die Daten zu synchronisieren.
...
mac-word-plugin-install-message = Trellis muss auf die Daten von Word zugreifen, um das Word-Plugin zu installieren.
