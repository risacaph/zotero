...
preferences-file-renaming-configure-button =
    .label = Umbenennung von Dateien einstellen…
...
preferences-account-waiting-for-login =
    .value = Auf die Anmeldung warten…
...
preferences-account-switch-confirmation-text = Lokale Daten entfernen
preferences-account-switch-accept = Daten entfernen und neu starten.
