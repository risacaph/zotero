...
import-source-file =
    .label = Een bestand (BibTeX, RIS, Trellis RDF, etc.)
...
publications-sharing-reserved =
    .label = Nee, publiceer mijn werk alleen op trellis.org
