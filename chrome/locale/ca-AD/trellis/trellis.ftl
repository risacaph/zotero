...
import-source-file =
    .label = Un fitxer (BibTex, RIS, Trellis RDF, etc.)
...
publications-intro = Els elements que afegiu a «Les meves publicacions» es mostraran en la pàgina de perfil de trellis.org. Si trieu incloure els fitxers adjunts, es posaran disponibles sota la llicència que hi especifiqueu. Només afegiu-hi treballs que hàgiu creat, i només incloeu-hi fitxers que tingueu els drets de distribució i vulgueu compartir.
...
publications-sharing-text = Podeu reservar-vos tots els drets del vostre treball, llicenciar-lo sota una llicència Creative Commons, o dedicar-lo al domini públic. En tots els casos el treball serà disponible públicament des de trellis.org.
publications-sharing-prompt = Voldríeu permetre que altres comparteixin el vostre treball?
publications-sharing-reserved =
    .label = No, només publica el meu treball a trellis.org
...
mac-word-plugin-install-message = El Trellis necessita accés a les dades del Word per a instal·lar el connector de Word.
