...
reader-annotation-comment = Коментар белешке
reader-annotation-text = Текст белешке
reader-manage-tags = Уреди ознаке за ову белешку
reader-open-menu = Отвори мени за белешке
reader-thumbnails = Сличице
reader-tag-selector-message = Филтрирај белешке на основу ове ознаке
reader-add-tags = Додај ознаке…
reader-highlight-text = Истакни текст
reader-underline-text = Подвуци текст
reader-add-note = Додај белешку
...
reader-draw = Нацртај
reader-eraser = Брисање
reader-pick-color = Одабери боју
reader-add-to-note = Додај белешку
reader-zoom-in = Увећај
reader-zoom-out = Умањи
reader-zoom-reset = Поништи увећање
reader-zoom-auto = Сам промени величину
reader-zoom-page-width = Уклопи висину странице
reader-zoom-page-height = Уклопи ширину странице
reader-split-vertically = Подели усправно
reader-split-horizontally = Подели водоравно
reader-next-page = Наредна страница
reader-previous-page = Претходна страница
...
reader-edit-page-number = Уреди број странице…
reader-edit-annotation-text = Уреди текст напомене
reader-copy-image = Копирај слику
reader-save-image-as = Сачувај слику као…
reader-page-number-popup-header = Промени број странице за:
reader-this-annotation = Ова напомена
reader-selected-annotations = Изабране напомене
reader-this-page = Ова страница
reader-this-page-and-later-pages = Ова и следеће странице
reader-all-pages = Све странице
reader-auto-detect = Сам пронађи
reader-enter-password = Унесите лозинку да отворите ПДФ датотеку
reader-include-annotations = Укључи напомене
reader-preparing-document-for-printing = Припремам документ за штампу…
reader-phrase-not-found = Израз није пронађен
reader-find = Нађи
reader-close = Затвори
reader-show-thumbnails = Прикажи сличице
reader-show-outline = Прикажи оквир
reader-find-previous = Пронађи претходно помињање фразе
reader-find-next = Пронађи наредно помињање фразе
reader-toggle-sidebar = Приказ бочне траке
reader-find-in-document = Пронађи у документу
reader-toggle-context-pane = Приказ контекстне површи
reader-highlight-all = Истакни све
reader-match-case = Разликуј велика и мала слова
reader-whole-words = Само целе речи
reader-appearance = Изглед
reader-epub-appearance-line-height = Дебљина линије
reader-epub-appearance-word-spacing = Размак између речи
reader-epub-appearance-letter-spacing = Размак између слова
reader-epub-appearance-page-width = Ширина странице
reader-epub-appearance-use-original-font = Користи оригинални фонт
reader-epub-appearance-line-height-revert = Користи подразумевану дебљину линије
reader-epub-appearance-word-spacing-revert = Користи подразумевани размак између речи
reader-epub-appearance-letter-spacing-revert = Користи подразумевани размак између слова
reader-epub-appearance-page-width-revert = Користи подразумевану ширину странице
reader-convert-to-highlight = Претвори у истакнуто
reader-convert-to-underline = Претвори у подвучено
