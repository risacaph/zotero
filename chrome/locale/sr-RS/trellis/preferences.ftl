...
preferences-note-title = Белешке
...
-preferences-sync-data-syncing = Усклађивање података
...
preferences-sync-reset-restore-to-server-yes = Замени податке у мрежној библиотеци
