...
publications-sharing-text = Можете задржати сва права над својим радом, поделити га под слободном лиценцом или га поделити преко јавног домена. У свим случајевима ће рад бити јавно доступан на страници trellis.org.
publications-sharing-prompt = Да ли желите да поделите свој рад са осталима?
publications-sharing-reserved =
    .label = Не, само објави моје податке на trellis.org.
