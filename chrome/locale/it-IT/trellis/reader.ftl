...
reader-highlight-annotation-short = Evidenzia
reader-underline-annotation = Annotazione: sottolineatura
reader-underline-annotation-short = Sottolinea
...
reader-theme-black = Nero
reader-add-theme = Aggiungi tema
reader-theme-invert-images = Inverti colori immagine
...
reader-reading-mode = Modalità lettura
reader-reading-mode-not-supported = La modalità lettura non è supportata in questo documento.
reader-clear-selection = Cancella la selezione
reader-epub-encrypted = Questo ebook è criptato e non può essere aperto.
...
reader-selected-pages =
    { $count ->
        [one] 1 pagina selezionata
        [many] { $count } pagine selezionate
...
reader-read-aloud-speed = Velocità di lettura
reader-read-aloud-voice = Voce
reader-read-aloud-voice-tier = Modalità voce
reader-read-aloud-voice-tier-local = Locale
reader-read-aloud-voice-tier-standard = Base
reader-read-aloud-voice-tier-premium = Premium
reader-read-aloud-more-voices = Altre voci...
reader-read-aloud-language = Lingua
reader-read-aloud-remaining-time = Tempo di lettura residuo
reader-read-aloud-log-in-link = <log-in>Accedi</log-in> per usare le voci di { -app-name }.
reader-read-aloud-log-in-button = Accedi
reader-read-aloud-done-button = { general-done }
reader-read-aloud-add-more-time = Aggiungi minuti
reader-read-aloud-quota-exceeded-message =
    <add-more-time>{ reader-read-aloud-add-more-time }</add-more-time> o continua la lettura con  { $tier ->
        [standard] Standard Voices
       *[local] Local Voices
    }.
reader-read-aloud-error = { general-error }
reader-read-aloud-error-unknown = Si è verificato un errrore sconosciuto.
reader-read-aloud-error-network = Unable to connect to the Read Aloud service. Please check your internet connection.
reader-read-aloud-error-daily-limit-exceeded = Hai superato il limite giornaliero per le voci { -app-name }.
reader-read-aloud-retry = Riprova
reader-read-aloud-first-run-title = Scegli la voce preferita:
reader-read-aloud-first-run-voice-tier-local-bullet-os-provided = Voci fornite dal sistema operativo
reader-read-aloud-first-run-voice-tier-local-bullet-offline = Disponibili senza una connessione a Internet
reader-read-aloud-first-run-voice-tier-local-bullet-no-account = Disponibili senza un account { -app-name }
reader-read-aloud-first-run-voice-tier-local-bullet-free = Totalmente gratuite
reader-read-aloud-first-run-voice-tier-standard-bullet-natural-sounding = Voci realistiche
reader-read-aloud-first-run-voice-tier-standard-bullet-online-only = Disponibili solo con una connessione a Internet
reader-read-aloud-first-run-voice-tier-standard-bullet-account-required = Richiedono un account { -app-name }
reader-read-aloud-first-run-voice-tier-standard-bullet-limited-languages = Numero di lingue limitato
reader-read-aloud-first-run-voice-tier-standard-bullet-no-multilingual = Nessun supporto multilingue
reader-read-aloud-first-run-voice-tier-standard-bullet-internal-processing = Il testo sorgente non lascia mai i server di { -app-name }
reader-read-aloud-first-run-voice-tier-standard-bullet-unlimited-with-subscription = Uso illimitato con un abbonamento { -subscription-name }
reader-read-aloud-first-run-voice-tier-premium-bullet-highest-quality = Voci di qualità superiore
reader-read-aloud-first-run-voice-tier-premium-bullet-online-only = Disponibili solo con una connessione a Internet
reader-read-aloud-first-run-voice-tier-premium-bullet-account-required = Richiedono un account { -app-name }
reader-read-aloud-first-run-voice-tier-premium-bullet-broad-languages = Ampia scelta di lingue
reader-read-aloud-first-run-voice-tier-premium-bullet-multilingual = Supporto multilingue
reader-read-aloud-first-run-voice-tier-premium-bullet-external-processing = Il testo sorgente è elaborato da fornitori esterni di sintesi vocale (TTS)
reader-read-aloud-first-run-voice-tier-premium-bullet-subscription-minutes = I piani di abbonamento { -subscription-name } includono dei tetti mensili per la voce Premium
reader-read-aloud-first-run-voice-tier-premium-bullet-beta-credits = Richiedi crediti per minuti aggiuntivi durante la beta
reader-read-aloud-sample-text = Io sono la voce locale { $name }
reader-read-aloud-voices-none-available = Nessuna voce disponibile
reader-read-aloud-first-run-no-voices-for-language = Le voci { $tier } non includono la lingua { $language }.
reader-read-aloud-region = Regione
reader-read-aloud-region-auto = Automatico
reader-read-aloud-annotation-popup-move = Sposta l'annotazione di una frase
reader-read-aloud-annotation-popup-extend = Estendi l'annotazione di una frase
reader-read-aloud-annotation-popup-delete = Elimina
reader-read-aloud-annotation-popup-done = Fatto
reader-read-aloud-annotation-popup-change-color = Cambia colore
reader-read-aloud-annotation-popup-highlight = Evidenzia
reader-read-aloud-annotation-popup-underline = Sottolinea
