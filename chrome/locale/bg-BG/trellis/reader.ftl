...
reader-highlight-text = Акцентиране на текст
reader-underline-text = Underline Text
reader-add-note = Добавяне на бележка
...
reader-underline-annotation-short = Подчертан
...
reader-read-aloud-options = Опции
...
reader-read-aloud-error-unknown = Възникна неизвестна грешка.
...
reader-read-aloud-annotation-popup-delete = Изтриване
...
reader-read-aloud-annotation-popup-underline = Подчертан
