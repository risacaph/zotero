...
import-source-file =
    .label = Tiedosto (BibTeX, RIS, Trellis RDF, jne.)
...
import-mendeley-encrypted = Valittua Mendeley-tietokantaa ei voitu lukea, todennäköisin syy on, että se on salattu. Katso lisätietoa ohjeesta <a data-l10n-name="mendeley-import-kb">How do I import a Mendeley library into Trellis?</a> .
...
publications-sharing-text = Voit pidättää kaikki oikeudet julkaisuihisi, jakaa ne Creative Commons -lisenssillä tai vapauttaa ne tekijänoikeudettomiksi (public domain). Kaikissa tapauksissa työsi on julkisesti saatavilla trellis.org:ssa.
publications-sharing-prompt = Saavatko muut levittää julkaisujasi edelleen?
publications-sharing-reserved =
    .label = Ei, näytä julkaisuni vain trellis.org:ssa.
...
account-not-logged-in-text = Kirjaudu Trellis-tilillesi synkronoidaksesi tietosi.
...
text-action-paste-and-search =
    .label = Liitä ja etsi
mac-word-plugin-install-message = Trellis vaatii pääsyn Wordin tietoihin jotta lisäosa voidaan asentaa
