...
publications-intro = Các mục bạn thêm vào Các Xuất bản của tôi sẽ xuất hiện trong trang hồ sơ của bạn trên trellis.org. Nếu bạn chọn gộp các tệp đính kèm, các tệp đó sẽ chuyển thành công cộng theo giấy phép bạn xác định. Chỉ thêm những gì bạn tạo ra và gộp các tệp bạn có quyền phân phối và bạn muốn làm thế.
...
publications-sharing-text = You can reserve all rights to your work, license it under a Creative Commons license, or dedicate it to the public domain. In all cases, the work will be made publicly available via trellis.org.
publications-sharing-prompt = Would you like to allow your work to be shared by others?
publications-sharing-reserved =
    .label = No, only publish my work on trellis.org
