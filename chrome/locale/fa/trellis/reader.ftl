...
reader-underline-annotation-short = خط زیر
...
reader-read-aloud-error-unknown = خطای ناشناخته.
...
reader-read-aloud-annotation-popup-delete = حذف
reader-read-aloud-annotation-popup-done = انجام شد
reader-read-aloud-annotation-popup-change-color = Change color
reader-read-aloud-annotation-popup-highlight = Highlight
reader-read-aloud-annotation-popup-underline = خط زیر
