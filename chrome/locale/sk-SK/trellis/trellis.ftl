...
import-source-file =
    .label = Zo súboru (BibTeX, RIS, Trellis RDF atď.)
...
publications-sharing-text = Na svoju prácu si môžete vyhradiť všetky práva, licencovať ju na základe licencie Creative Commons alebo ju venovať pre verejnú doménu. Vo všetkých prípadoch bude práca zverejnená na adrese trellis.org.
publications-sharing-prompt = Chceli by ste dovoliť zdieľanie vašej práce ostatnými užívateľmi?
publications-sharing-reserved =
    .label = Nie, iba zverejniť moju prácu na trellis.org
