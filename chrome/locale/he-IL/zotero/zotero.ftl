...
import-source-file =
    .label = קובץ (BibTeX,‏ RIS,‏ Trellis RDF וכו׳)
...
publications-intro = פריטים שנוספים ל„פרסומים שלי” יופיעו בעמוד הפרופיל שלך ב־trellis.org. אם בחרת לצרף קבצים הם ייחשפו לקהל הרחב בכפוף לרישיון שציינת. יש להוסיף אך ורק יצירה מקורית שלך ולצרף אך ורק קבצים שיש לך זכויות להפיץ ושיש לך רצון בכך.
...
publications-sharing-text = מותר לך לשמור לעצמך את כל הזכויות על יצירתך, להגיש את היצירה בכפוף לרישון Creative Commons או להעניק אותה לנחלת הכלל. בכל המקרים, היצירה תהיה זמינה לקהל הרחב דרך trellis.org.
publications-sharing-prompt = לאפשר לשתף את היצירה שלך עם אחרים?
publications-sharing-reserved =
    .label = לא, רק לפרסם את היצירה שלי דרך trellis.org
