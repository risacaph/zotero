...
import-source-file =
    .label = 単一ファイル (BibTeX, RIS, Trellis RDF, など.)
...
publications-intro = 「私の出版物」に追加したアイテムは、trellis.org のプロフィールページに表示されます。添付ファイルを含めることを選択した場合、それらは指定したライセンスの下で公開されます。あなた自身が作成した著作物のみを加えてください。また、配布を希望し、かつ配布する権利を持つファイルのみを含めてください。
...
publications-sharing-text = 著作物のすべての権利を留保することも、クリエイティブ・コモンズ・ライセンスの下でライセンスすることも、パブリック ドメインに捧げることも可能です。いずれの場合も、あなたの著作物は trellis.org を通じて公開されます。
publications-sharing-prompt = あなたの著作物を他の人と共有できるようにしますか？
publications-sharing-reserved =
    .label = いいえ、私の著作物は trellis.org でのみ公開してください
