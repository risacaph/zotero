...
reader-highlight-text = Verligmerk teks
...
reader-underline-annotation-short = Onderstreep
...
reader-read-aloud-annotation-popup-delete = Skrap
...
reader-read-aloud-annotation-popup-underline = Onderstreep
