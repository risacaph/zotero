...
publications-intro = Item yang Anda tambahkan ke Publikasi Saya akan ditampilkan di halaman profil Anda di trellis.org. Jika Anda memilih untuk menyertakan file lampiran, file tersebut akan tersedia untuk umum di bawah lisensi yang Anda tentukan. Hanya tambahkan karya yang Anda buat sendiri, dan hanya sertakan file jika Anda memiliki hak untuk mendistribusikannya dan ingin melakukannya.
...
publications-sharing-text = Anda dapat menjaga semua hak atas karya Anda, melisensikannya di bawah lisensi Creative Commons, atau mendedikasikannya ke domain publik. Dalam semua kasus, karya tersebut akan tersedia untuk umum melalui trellis.org.
publications-sharing-prompt = Apakah Anda ingin karya Anda dibagikan oleh orang lain?
publications-sharing-reserved =
    .label = Tidak, hanya terbitkan karya saya di trellis.org
