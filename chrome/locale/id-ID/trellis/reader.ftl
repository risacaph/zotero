...
reader-highlight-text = Tandai Teks
reader-underline-text = Underline Text
reader-add-note = Tambahkan Catatan
...
reader-underline-annotation-short = Garis Bawah
...
reader-clear-selection = Hapus Seleksi
...
reader-read-aloud-language = Bahasa
...
reader-read-aloud-error-unknown = Sebuah kesalahan yang tidak dikenal telah terjadi.
...
reader-read-aloud-annotation-popup-delete = Hapus
reader-read-aloud-annotation-popup-done = Selesai
reader-read-aloud-annotation-popup-change-color = Change color
reader-read-aloud-annotation-popup-highlight = Highlight
reader-read-aloud-annotation-popup-underline = Garis Bawah
