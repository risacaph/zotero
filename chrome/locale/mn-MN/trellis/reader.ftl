...
reader-clear-selection = Сонголтыг цэвэрлэх
...
reader-read-aloud-error-unknown = Үл мэдэгдэх алдаа гарлаа.
...
reader-read-aloud-annotation-popup-delete = Устгах
