...
import-source-file =
    .label = Un fișier (BibTeX, RIS, Trellis RDF etc.)
...
publications-intro = Itemii pe care îi adaugi în Publicațiile mele vor fi afișați în profilul tău pe trellis.org. Dacă alegi să incluzi fișiere anexate, acestea vor fi disponibile public sub licența pe care o specifici. Adaugă doar ceea ce ai creat tu însuți și adaugă fișiere doar dacă ai drepturile de a le distribui și vrei să o faci.
...
publications-sharing-text = Poți rezerva toate drepturile pentru lucrările tale, licența este Creative Commons, sau să le oferi domeniului public. În fiecare caz, lucrările vor fi disponibile public via trellis.org.
publications-sharing-prompt = Vrei să permiți ca alții să aibă dreptul de a distribui lucrările tale?
publications-sharing-reserved =
    .label = Nu, publică lucrările mele doar pe trellis.org
