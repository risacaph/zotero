...
preferences-locate-resolver = Rezolvator:
...
-preferences-sync-data-syncing = Sincronizare date
...
preferences-sync-reset-restore-to-server-yes = Înlocuiește datele din biblioteca online.
