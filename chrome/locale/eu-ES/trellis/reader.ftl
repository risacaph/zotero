...
reader-underline-annotation-short = Azpimarra
...
reader-read-aloud-options = Aukerak
...
reader-read-aloud-error-unknown = Errore ezezagun bat gertatu da.
...
reader-read-aloud-region-auto = Automatikoa
...
reader-read-aloud-annotation-popup-delete = Ezabatu
reader-read-aloud-annotation-popup-done = Egina
reader-read-aloud-annotation-popup-change-color = Change color
reader-read-aloud-annotation-popup-highlight = Highlight
reader-read-aloud-annotation-popup-underline = Azpimarra
