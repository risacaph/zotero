...
import-source-file =
    .label = Fitxategi bat (BibTex, RIS, Trellis RDF etab.)
...
publications-intro = Nire argitalpenak atalean gehitzen dituzun elementuak zure profilean erakutsiko dira trellis.org webgunean. Atxikitako fitxategiak erakustea hautatzen baduzu, publikoki eskuragarri jarriko dira zehazten duzun lizentziarekin. Zuk zeuk sortutako lanak bakarrik gehitu, eta zabaltzeko eskumena daukazun eta zabaldu nahi dituzun fitxategiak gehitu bakarrik.
...
publications-sharing-text = Zure lanaren inguruko eskubide guztiak gorde ditzakezu, Creative Commons lizentzia baten pean eskuragarri jarri, ala domeinu publikoko egin. Edozein kasutan, lana publikoki eskuragarri jarriko da trellis.org wegunean.
publications-sharing-prompt = Besteek zure lana partekatzea baimendu nahi al duzu?
publications-sharing-reserved =
    .label = Ez, nire lana trellis.org-en argitaratu soilik
