...
import-source-file =
    .label = Soubor (BibTeX, RIS, Trellis RDF, atd.)
...
import-mendeley-encrypted = Vybranou databázi Mendeley nelze přečíst, pravděpodobně proto, že je zašifrovaná. Viz <a data-l10n-name="mendeley-import-kb">Jak naimportuji knihovnu Mendeley do Trellis?</a> pro další informace.
...
publications-sharing-text = Můžete si vyhradit všechna práva ke svému dílu, licencovat jej pod licencí Creative Commons nebo je věnovat veřejné doméně. Ve všech případech bude dílo veřejně k dispozici prostřednictvím trellis.org
publications-sharing-prompt = Umožníte sdílení vaší práce jinými?
publications-sharing-reserved =
    .label = Ne, publikovat jen na trellis.org
...
mac-word-plugin-install-message = K instalaci doplňku pro Word potřebuje Trellis přístup k datům Wordu.
