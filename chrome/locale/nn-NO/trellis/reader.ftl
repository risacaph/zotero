...
reader-underline-annotation-short = Understreka
...
reader-read-aloud-error-unknown = Ein ukjend feil oppstod.
...
reader-read-aloud-annotation-popup-underline = Understreka
