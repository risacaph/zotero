...
import-source-file =
    .label = Um arquivo (BibTeX, RIS, RDF do Trellis, etc.)
...
import-mendeley-encrypted = A base Mendeley selecionada não pode ser lida, possivelmente porque é criptografada. Veja <a data-l10n-name="mendeley-import-kb">Como importar biblioteca do Mendeley para o Trellis?</a> para mais informações.
...
publications-intro = Itens que você adiciona a Minhas Publicações serão mostrados na sua página de perfil em trellis.org. Se você escolher incluir arquivos anexos, eles serão disponibilizados publicamente sob a licença que você especificar. Adicione apenas trabalhos que foram criados por você e inclua arquivos apenas se você tem direitos de distribuição e assim o deseja.
...
publications-sharing-text = Você pode reservar todos os direitos para seu trabalho usando a licença Creative Commons ou deixá-lo em domínio público. Em ambos os casos, o trabalho ficará publicamente disponível em trellis.org.
publications-sharing-prompt = Você gostaria de permitir que o seu trabalho seja compartilhado por outros?
publications-sharing-reserved =
    .label = Não, somente publique meu trabalho no trellis.org
...
mac-word-plugin-install-message = Trellis precisa acessar os dados do Word para instalar a extensão do Word.
