...
import-source-file =
    .label = 文件（BibTeX、RIS、Trellis RDF 等）
...
import-mendeley-encrypted = 无法读取所选的 Mendeley 数据库，可能是因为它已加密。请参阅<a data-l10n-name="mendeley-import-kb">如何将 Mendeley 库导入 Trellis？</a>了解更多信息。
...
publications-intro = 你添加到我的出版物的条目将在 trellis.org 上你的个人主页上显示。如果你选择加入附件，这些文件将在你指定的许可下向公众开放下载。请仅添加你自己创建的论文，并仅上传你有权并愿意分享的文件。
...
publications-sharing-keep-rights-field-where-available =
    .label = 尽可能保留现有的版权字段
publications-sharing-text = 您可以保留对作品的所有权利，可以在知识共享许可下发布，也可以发布于公有领域。在所有情况下，这些作品都可以通过 trellis.org 公开获得。
publications-sharing-prompt = 您想允许他人共享您的作品吗？
publications-sharing-reserved =
    .label = 不，仅允许 trellis.org 发布我的作品
...
account-log-in = 登录
account-not-logged-in-text = 登录Trellis账户以同步你的数据。
...
text-action-paste-and-search =
    .label = 粘贴并搜索
mac-word-plugin-install-message = Trellis 需要访问 Word 数据才能安装 Word 插件。
