...
import-source-file =
    .label = iš rinkmenos (BibTeX, RIS, Trellis RDF ar kt.)
...
import-mendeley-encrypted = Nepavyksta nuskaityti Mendeley duombazės, galbūt ji užšifruota. Daugiau informacijos rasite straipsnelyje <a data-l10n-name="mendeley-import-kb">Kaip importuoti Mendeley biblioteką į Trellis?</a>.
...
publications-intro = „Nuosavose publikacijose“ patalpinti įrašai rodysimi Trellis.org svetainėje jūsų profilyje. Jei pasirenkate įtraukti prisegtas rinkmenas, jos bus viešai prieinamos pagal jūsų pasirinktą licenciją. „Nuosavoms publikacijoms“ priskirkite tik tuos darbus, kuriuos patys kūrėte, o rinkmenas viešinkite tik jei turite teisę tą daryti.
...
publications-sharing-text = Galite išlaikyti visas savo teises į darbą, galite platinti pagal „Creative Commons“ (CC) licenciją arba galite jį priskirti viešai sričiai (CC0). Bet kuriuo atveju publikacija paviešinsima per trellis.org.
publications-sharing-prompt = Ar leidžiate kitiems dalintis jūsų darbu?
publications-sharing-reserved =
    .label = Ne, tik paviešinti darbą per trellis.org
...
mac-word-plugin-install-message = Trellis turi galėti prieiti prie „Word“ duomenų tam, kad galėtų įdiegti papildinį „Word“ programai.
