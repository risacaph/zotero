...
import-source-file =
    .label = En fil (BibTeX, RIS, Trellis RDF, etc.)
...
import-mendeley-encrypted = Den valgte Mendeley-databasen kan ikke leses, sannsynligvis fordi den er kryptert. Se  <a data-l10n-name="mendeley-import-kb">How do I import a Mendeley library into Trellis? (Engelsk)</a> for mer informasjon.
...
rtfScan-complete-page-description = Trellis har nå gått gjennom dokumentet ditt. Sjekk at det er korrekt formatert.
...
publications-intro = Elementer du legger til Mine publikasjoner vil bli vist på din profilside på trellis.org. Hvis du velger å inkludere vedlegg vil de bli gjort offentlig tilgjengelig under lisensen du angir. Legg kun til arbeid du selv har opprettet og inkluder vedlegg kun dersom du har rettighetene til å distribuere de og ønsker å gjøre det.
...
publications-sharing-text = Du kan forbeholde deg alle rettigheter til ditt arbeid, lisensere det under en Creative Commons lisens, eller gjøre det offentlig tilgjengelig. I alle tilfeller, arbeidet vil bli gjort tilgjengelig via trellis.org.
publications-sharing-prompt = Vil du tillate at arbeidet ditt blir delt med andre?
publications-sharing-reserved =
    .label = Nei, kun publiser mitt arbeid på trellis.org
...
account-not-logged-in-text = Logg inn på Trellis-kontoen din for å synkronisere dataene dine.
...
mac-word-plugin-install-message = Trellis trenger tilgang til Word-data for å installere Word-programtillegget.
