...
import-source-file =
    .label = Un archivo (BibTex, RIS, Trellis RDF, etc.)
...
import-mendeley-encrypted = La base de datos Mendeley seleccionada no se puede leer, probablemente porque está encriptada. Consulte <a data-l10n-name="mendeley-import-kb">¿Cómo importo una biblioteca Mendeley a Trellis?</a> para obtener más información.
...
publications-sharing-text = Puede reservarse todos los derechos de su trabajo, licenciarlo bajo una licencia Creative Commons o publicarlo en dominio público. En todos los casos, el trabajo se pondrá a disposición del público a través de trellis.org.
publications-sharing-prompt = ¿Le gustaría permitir que otros compartan su trabajo?
publications-sharing-reserved =
    .label = No, publicar mi trabajo únicamente en trellis.org.
...
account-not-logged-in-text = Inicie sesión en su cuenta de Trellis para sincronizar sus datos.
...
mac-word-plugin-install-message = Trellis necesita acceder a los datos de Word para instalar la extensión de Word
