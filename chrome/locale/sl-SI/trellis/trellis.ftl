...
import-source-file =
    .label = Datoteka (BibTeX, RIS, Trellis RDF itn.)
...
publications-intro = Vnosi, ki jih dodate med Moje objave, bodo prikazane na strani vašega profila na trellis.org. Če izberete vključitev pripetih datotek, bodo javno objavljene pod pogoji dovoljenja, ki ga izberete. Dodajte le dela, ki ste jih ustvarili sami in za katera imate ustrezne pravice, da jih lahko (in jih tudi želite) razširjati na tak način.
...
publications-sharing-text = Vse pravice glede svojega dela lahko obdržite, delo lahko objavite pod dovoljenjem Creative Commns ali pa ga predate v javno domeno. V vsakem primeru bo delo javno dostopno prek trellis.org
publications-sharing-prompt = Želite dovoliti, da drugi dajejo vaše delo v skupno rabo?
publications-sharing-reserved =
    .label = Ne, objavi moje delo le na trellis.org
...
mac-word-plugin-install-message = Trellis potrebuje dostop do podatkov Word za namestitev vstavka za Word.
