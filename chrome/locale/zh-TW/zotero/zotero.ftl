...
import-source-file =
    .label = 一檔案 (BibTeX, RIS, Trellis RDF, 等)
...
import-mendeley-encrypted = 無法讀取所選的 Mendeley 資料庫，可能是因為它已加密。請參閱<a data-l10n-name="mendeley-import-kb">如何將 Mendeley 文獻庫匯入 Trellis？</a>來了解更多資訊。
...
publications-intro = 您所新增到我的著作中的項目將在 trellis.org 上您的個人頁面中顯示。如果您選擇包含附件檔案，這些檔案將在您所指定的許可協議下開放存取。請僅新增您自己創作的著作，並僅加入您所擁有著作權且願意分享的檔案。
...
publications-sharing-keep-rights-field-where-available =
    .label = 可以的話保留現存的版權欄位
publications-sharing-text = 您可以保留您對您作品的所有權利，可以在創用CC授權協議下授權，也可以將其貢獻到公共領域。在所有狀況下，這些著作都可以透過trellis.org公開取得。
publications-sharing-prompt = 您想允許您的著作被分享給他人嗎？
publications-sharing-reserved =
    .label = 不，只在trellis.org公開我的著作
...
text-action-paste-and-search =
    .label = 貼上並搜尋
mac-word-plugin-install-message = Trellis 需要存取 Word 資料來安裝 Word 外掛
