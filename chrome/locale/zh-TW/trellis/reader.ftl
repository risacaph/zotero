...
reader-underline-annotation-short = 底線
...
reader-read-aloud-error-unknown = 出現一個不明的錯誤。
...
reader-read-aloud-annotation-popup-delete = 刪除
