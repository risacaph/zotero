...
reader-underline-annotation-short = Understreck
...
reader-read-aloud-options = Alternativ
...
reader-read-aloud-error-unknown = Ett okänt fel har uppstått
...
reader-read-aloud-annotation-popup-delete = Radera
reader-read-aloud-annotation-popup-done = Klar
reader-read-aloud-annotation-popup-change-color = Change color
reader-read-aloud-annotation-popup-highlight = Highlight
reader-read-aloud-annotation-popup-underline = Understreck
