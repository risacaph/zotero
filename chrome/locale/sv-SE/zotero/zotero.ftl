...
publications-sharing-text = Du kan reservera alla rättigheter till det verk, licensiera det enligt en Creative Commons-licens eller överlämna det som allmän egendom (public domain). I samtliga fall kommer verket att vara tillgängligt för allmänheten via trellis.org.
publications-sharing-prompt = Medger du att ditt verk delas med andra?
publications-sharing-reserved =
    .label = Nej, publicera mitt verk endast på trellis.org
