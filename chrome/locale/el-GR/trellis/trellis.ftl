...
import-source-file =
    .label = Ένα αρχείο (BibTeX, RIS, Trellis RDF, κλπ.)
...
publications-intro = Τα στοιχεία που προσθέτετε στις Δημοσιεύσεις μου θα εμφανίζονται στη σελίδα του προφίλ σας στο trellis.org. Αν επιλέξετε να συμπεριλάβετε τα συνημμένα αρχεία, θα είναι διαθέσιμα στο κοινό με την άδεια που καθορίζετε. Προσθέστε μόνο την εργασία που έχετε δημιουργήσει εσείς και συμπεριλάβετε μόνο αρχεία εάν έχετε τα δικαιώματα διανομής και θέλετε να το κάνετε.
...
publications-sharing-text = Μπορείτε να διατηρήσετε όλα τα δικαιώματα της εργασία σας, να την εκχωρήσετε με άδεια Creative Commons ή να την αφιερώσετε στον δημόσιο τομέα. Σε όλες τις περιπτώσεις, οι εργασίες θα δημοσιοποιηθούν μέσω του trellis.org.
publications-sharing-prompt = Θέλετε να επιτρέψετε την κοινή χρήση της εργασίας σας από άλλους;
publications-sharing-reserved =
    .label = Όχι, δημοσιεύστε το έργο μου μόνο στο trellis.org
