...
reader-highlight-text = Υπογράμμιση κειμένου
reader-underline-text = Underline Text
reader-add-note = Προσθήκη σημείωσης
...
reader-underline-annotation-short = Υπογραμμισμένα
...
reader-split-vertically = Διαχωρισμός Κάθετα
reader-split-horizontally = Διαχωρισμός Οριζόντια
...
reader-whole-words = Ολόκληρες λέξεις
...
reader-clear-selection = Καθαρισμός επιλογής
...
reader-read-aloud-options = Επιλογές
...
reader-read-aloud-voice-tier-standard = Βασική τυποποίηση
reader-read-aloud-voice-tier-premium = Premium
reader-read-aloud-more-voices = More Voices…
reader-read-aloud-language = Γλώσσα
...
reader-read-aloud-error-unknown = Παρουσιάστηκε άγνωστο σφάλμα.
...
reader-read-aloud-annotation-popup-delete = Διαγραφή
reader-read-aloud-annotation-popup-done = Ολοκληρώθηκε
reader-read-aloud-annotation-popup-change-color = Change color
reader-read-aloud-annotation-popup-highlight = Highlight
reader-read-aloud-annotation-popup-underline = Υπογραμμισμένα
