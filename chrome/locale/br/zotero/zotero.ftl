...
import-source-file =
    .label = Ur restr (BibTeX, RIS, Trellis RDF, hag all hag all...)
...
publications-intro = Elfennoù da ouzhpennañ D'am Embannadennoù hag a vo diskouezet war pajenn ho profil war trellis.org. Ma tibabit enklozañ restroù-stag, lakaet e vint hegerz en un doare foran dindan al lisañs a vo termenet ganeoc'h. Ouzhpennit labourioù a zo bet krouet ganeoc'h hepken, hag enklozit ar restroù ho peus ar gwir rannañ warno hag ho peus c'hoant d'en ober.
...
publications-sharing-text = Gellout a rit mirout kement gwir d'ho labour, lakaat anezhañ dindan ul lisañs Creative Commons, pe dediet d'an domani foran. E kement degouezh e vo lakaet hegerz en un doare foran dre trellis.org.
publications-sharing-prompt = Ha fellout a rafe deoc'h aotren ar fet ma vefe rannet ho labour gant tud all?
publications-sharing-reserved =
    .label = Ket, embann ma labour war trellis.org hepken
