...
preferences-note-title = Notennoù
...
preferences-locate-resolver = Diskoulmer:
...
-preferences-sync-data-syncing = Sinkro ar roadennoù
...
preferences-sync-reset-restore-to-server-yes = Erlec'hiañ ar roadennoù e-barzh al levraouegoù enlinenn
