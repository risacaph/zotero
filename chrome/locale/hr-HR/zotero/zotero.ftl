...
publications-sharing-text = Možete zadržati sva prava na svoj rad, licencirati ga pod licencijom Creative Commons ili ga posvetiti javnoj domeni. U svim slučajevima, rad će biti javno dostupan putem trellis.org.
publications-sharing-prompt = Želite li dopustiti drugima da dijele Vaš rad?
publications-sharing-reserved =
    .label = Ne, moj rad objavi samo na trellis.org
