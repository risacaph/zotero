...
reader-annotation-comment = Komentar anotacija
reader-annotation-text = Tekst anotacija
...
reader-add-tags = Dodaj oznake...
reader-highlight-text = Istakni tekst
reader-underline-text = Podcrtaj tekst
reader-add-note = Dodaj bilješku
reader-add-text = Dodaj tekst
reader-select-area = Odaberi područje
...
reader-underline-annotation-short = Podcrtano
...
reader-search-result-index = Rezultati pretraživanja
reader-search-result-total = Ukupni rezultati pretraživanja
reader-draw = Crtaj
reader-eraser = Gumica
reader-pick-color = Odaberi boju
reader-add-to-note = Dodaj u bilješku
reader-zoom-in = Povećaj zum
reader-zoom-out = Smanji zum
reader-zoom-reset = Resetiraj zum
...
reader-split-vertically = Podijeli vertikalno
reader-split-horizontally = Podijeli horizontalno
reader-next-page = Sljedeća stranica
reader-previous-page = Prethodna stranica
...
reader-read-aloud-options = Mogućnosti
...
reader-read-aloud-error-unknown = Dogodila se nepoznata greška.
...
reader-read-aloud-region-auto = Automatski
