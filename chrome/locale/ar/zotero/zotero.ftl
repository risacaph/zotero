...
import-source-file =
    .label = ملف (BibTeX, RIS, Trellis RDF, etc.)
...
publications-intro = سيتم عرض العناصر التي تضيفها إلى منشوراتي على صفحة ملفك الشخصي على trellis.org. إذا اخترت تضمين الملفات المرفقة، سيتم إتاحتها للجمهور تحت الرخصة التي تحددها. أضف الأعمال التي ألفتها فقط، و لا تضمن الملفات إلا إن كان لديك الحق في توزيعها وترغب في القيام بذلك.
...
publications-sharing-text = يمكنك حفظ جميع الحقوق لعملك، أو ترخيصها تحت رخصة المشاع الإبداعي، أو هبتها كملكية عامة. في جميع الحالات، سيتاح مؤلفك للجمهور عبر trellis.org.
publications-sharing-prompt = هل ترغب في السماح للآخرين بمشاركة مؤلفك ؟
publications-sharing-reserved =
    .label = لا ، انشر عملي علي trellis.org فقط
