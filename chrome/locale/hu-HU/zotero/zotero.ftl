...
import-source-file =
    .label = Egy fájl (BibTeX, RIS, Trellis RDF, stb.)
...
import-mendeley-encrypted = A kiválasztott Mendeley-adatbázis nem olvasható, valószínűleg azért, mert titkosítva van. További információkért lásd: <a data-l10n-name="mendeley-import-kb">Hogyan importálhatok egy Mendeley könyvtárat a Trellis programba?</a>
...
publications-sharing-text = Fenntarthatja a munkájához fűződő összes jogot, licencelheti a Creative Commons licenc alapján, vagy a köztulajdonnak nyilváníthatja. A munkát minden esetben nyilvánosan elérhetővé teszik a trellis.org oldalon.
publications-sharing-prompt = Engedélyezné, hogy mások is megosszák a munkáját?
publications-sharing-reserved =
    .label = Nem, csakis a trellis.org weboldalon publikálható a munkám
...
mac-word-plugin-install-message = A Trellis a Word bővítmény telepítéséhez hozzáférést igényel a Word-fájlokhoz.
