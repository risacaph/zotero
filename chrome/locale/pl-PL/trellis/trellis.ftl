...
import-source-file =
    .label = Z pliku (BibTeX, RIS, Trellis RDF itp.)
...
import-mendeley-encrypted = Nie można odczytać wybranej bazy danych Mendeley, ponieważ jest zaszyfrowana. Aby uzyskać więcej informacji, zobacz <a data-l10n-name="mendeley-import-kb">Jak zaimportować bibliotekę Mendeley do Trellis?</a>.
...
publications-sharing-text = Możesz zastrzec wszystkie prawa do swojej pracy, udostępnić ją na licencji Creative Commons, albo przekazać do domeny publicznej. W każdym z tych przypadków, praca będzie dostępna publicznie na trellis.org.
publications-sharing-prompt = Czy chcesz zezwolić innym na wykorzystanie twojej pracy?
publications-sharing-reserved =
    .label = Nie, tylko opublikuj moją pracę na trellis.org
...
account-not-logged-in-text = Zaloguj się do swojego konta Trellis, aby zsynchronizować swoje dane.
...
mac-word-plugin-install-message = Do instalacji wtyczki Word wymagany jest dostęp Trellis do danych Word.
