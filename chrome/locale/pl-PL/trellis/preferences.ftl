...
preferences-file-renaming-configure-button =
    .label = Konfiguruj zmianę nazw plików...
...
preferences-account-switch-confirmation-text = usuń dane lokalne
preferences-account-switch-accept = Usuń dane i uruchom ponownie
