...
reader-ink-annotation = Notatka odręczna
...
reader-theme-black = Czarny
reader-add-theme = Dodaj styl
reader-theme-invert-images = Odwróć kolory obrazów
...
reader-epub-encrypted = Ten ebook jest zaszyfrowany i nie może zostać otwarty.
...
reader-read-aloud-sample-text = Jestem głosem lokalnym { $name }
reader-read-aloud-voices-none-available = Brak dostępnych głosów
reader-read-aloud-first-run-no-voices-for-language = { $tier } Głosy nie obsługują { $language }.
