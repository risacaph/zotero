...
import-source-file =
    .label = Un ficheiro (BibTeX, RIS, Trellis RDF, etc.)
...
publications-intro = Os elementos que se engaden ás Miñas publicacións móstranse no teu perfil público na páxina de trellis.org. Se escolleu engadir ficheiros anexos, estes van a estar accesibles ao público baixo a licenza que especificase. Engade só aquel traballo que fixeras ti, e só aqueles ficheiros dos cales teñas permiso e queiras distribuílos.
...
publications-sharing-text = Pode reservar todos os dereitos da túa obra, darlle unha licenza Creative Commons ou cedela ao dominio público. En calquera caso, a obra estará dispoñible para o público en trellis.org.
publications-sharing-prompt = Queres permitir que a túa obra se comparta con outros?
publications-sharing-reserved =
    .label = Non, só publicala en trellis.org.
