...
import-source-file =
    .label = Um arquivo (BibTeX, RIS, Trellis RDF, etc.)
...
publications-sharing-text = Pode reservar todos os direitos do seu trabalho, licenciá-lo sob uma licença Creative Commons ou colocá-lo no domínio público. Em qualquer dos casos, o trabalho será disponibilizado publicamente através de trellis.org.
publications-sharing-prompt = Gostaria de permitir que outros possam partilhar o seu trabalho?
publications-sharing-reserved =
    .label = Não, publique apenas o meu trabalho em trellis.org
