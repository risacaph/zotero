...
export default [
	...
	
	{
		...
		languageOptions: {
			globals: {
				...
				TrellisPane_Local: "readonly",
				TrellisPane: "readonly",
				Trellis_Tabs: "readonly",
				TrellisContextPane: "readonly",
				Trellis_File_Interface: "readonly",
				Trellis_LocateMenu: "readonly",
				IOUtils: "readonly",
				NetUtil: "readonly",
				FileUtils: "readonly",
				globalThis: "readonly",
	...
	
	{
		ignores: [
			"build/*",
			"chrome/content/trellis/xpcom/citeproc.js",
			"chrome/content/trellis/xpcom/isbn.js",
			"chrome/content/trellis/xpcom/rdf/*",
			"chrome/content/trellis/xpcom/xregexp/*",
			"chrome/content/trellis/xpcom/translation/tlds.js",
			"resource/bluebird/*",
